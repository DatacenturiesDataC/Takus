...
export function renderConsentNotice(container) {
  container.innerHTML = `
    <div class="consent-banner" id="consent-banner">
      ...
      <span class="flex-1"><strong>Recording notice:</strong> Always inform other participants before entry. Recording consent laws vary by jurisdiction.</span>
...
export function renderFooter(container) {
  container.innerHTML = `
    ...
    <div style="text-align:center; padding-bottom:var(--space-4);">
      <span class="text-xs text-disabled">© 2026 Takus. All rights reserved.</span>
    </div>
  `;
}
